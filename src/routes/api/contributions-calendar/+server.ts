...
import { CONTRIBUTION_CALENDAR_QUERY, LEVELS, type IContributionCollection } from '$lib/github';
...
export const GET: RequestHandler = async ({ url, fetch }) => {
	...
	const res = await fetch('https://api.github.com/graphql', {
		...
		body: JSON.stringify({ query: CONTRIBUTION_CALENDAR_QUERY, variables: { user, from, to } }),
	});
